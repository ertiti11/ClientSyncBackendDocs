---
title: ClientSync Docs
description: Documentacion oficial de Clientsync
template: splash
hero:
  tagline: Empieza a trabajr ya
  image:
...
<Card title="Laravel Cheatsheet">
Esta es una guía rápida de Laravel para recordar los comandos y funciones más comunes.
</Card>

<Aside type="caution" title="Cuidado">Cuidado con subir contraseñas o keys en los archivos env</Aside>
## Project Commands
